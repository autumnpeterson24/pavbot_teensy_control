...
public:
  TeensySerialTransport() : Node("teensy_transport_serial") {
    //PARAMETERIZE THESE
    port_     = this->declare_parameter<std::string>("port", "/dev/serial/by-id/usb-Teensyduino_USB_Serial_9147040-if00"); //usb-Teensyduino_USB_Serial_9147050-if00 = (TEST BENCH TEENSY)
